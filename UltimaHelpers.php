 ...
 */
    public static function explodeUrl($sUrl)
    {
        $aUrl = parse_url($sUrl);
     ...
     */
    public static function implodeUrl($aUrl)
    {
    //[scheme]://[user]:[pass]@[host]/[path]?[query]#[fragment]
     ...
     * @return Array
     */
    public static function getUrlParams($sUrl)
    {
        $aUrl = self::explodeUrl($sUrl);
     ...
     * @return  String Newly compiled url
     */
    public static function updateUrlParams($sUrl, $aParams)
    {
        $aUrl = self::explodeUrl($sUrl);
        $aUrl['query'] = '';
